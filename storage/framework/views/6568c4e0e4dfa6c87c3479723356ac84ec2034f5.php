        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-1">
                <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6 border-t-4 border-[#E31E24]">
                    ...
                    <form action="<?php echo e(route('admin.topping.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <table class="w-full text-left text-gray-900 dark:text-gray-300">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                    <td class="py-3 px-4 font-semibold"><?php echo e($topping->nama_topping); ?></td>
                                    <td class="py-3 px-4">
                                        <span class="bg-gray-200 text-gray-800 text-xs font-bold px-2.5 py-0.5 rounded"><?php echo e($topping->kategori_makanan); ?></span>
                                    </td>
                                    <td class="py-3 px-4 text-[#E31E24] font-bold">+ Rp <?php echo e(number_format($topping->harga, 0, ',', '.')); ?></td>
                                    <td class="py-3 px-4">
                                        <form action="<?php echo e(route('admin.topping.destroy', $topping->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\miraicoffee\resources\views/admin/topping.blade.php ENDPATH**/ ?>