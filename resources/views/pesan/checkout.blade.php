            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full border-collapse border border-gray-300 dark:border-gray-700 text-gray-900 dark:text-gray-200">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $no++ }}</td>
                                    ...
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-sm">
                                        @if($pesanan_detail->kemanisan) <span class="bg-amber-100 text-amber-800 px-2 py-1 rounded">Manis Lv {{ $pesanan_detail->kemanisan }}</span> <br> @endif
                                        @if($pesanan_detail->kepahitan) <span class="bg-stone-200 text-stone-800 px-2 py-1 rounded mt-1 inline-block">Pahit Lv {{ $pesanan_detail->kepahitan }}</span> @endif
                                    </td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 text-center">{{ $pesanan_detail->jumlah }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2">Rp. {{ number_format($pesanan_detail->barang->harga, 0, ',', '.') }}</td>
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-2 font-bold">Rp. {{ number_format($pesanan_detail->jumlah_harga, 0, ',', '.') }}</td>
                                ...
                                <tr class="bg-gray-50 dark:bg-gray-800">
                                    ...
                                    <td class="border border-gray-300 dark:border-gray-600 px-4 py-3">
                                        <a href="{{ url('konfirmasi-checkout') }}" class="bg-green-600 hover:bg-green-700 text-white font-bold py-2 px-4 rounded w-full block text-center shadow" onclick="return confirm('Apakah pesanan sudah benar? Proses Check Out sekarang?')">
                                            Check Out
                                        </a>
                                    </td>
                                </tr>
                ...
                @else
                    <div class="text-center py-8">
                        ...
                        <a href="{{ url('home') }}" class="inline-block mt-4 text-amber-600 hover:text-amber-800 font-semibold underline">Mulai Pesan Kopi</a>
                    </div>
                @endif
