                    ...
                    <table class="w-full text-left text-gray-900 dark:text-gray-300">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                <td class="py-4 px-4 font-semibold text-[#E31E24]">{{ $barang->nama_barang }}</td>
                                <td class="py-4 px-4 uppercase text-xs font-bold text-gray-500">{{ $barang->kategori }}</td>
                                ...
                                <td class="py-4 px-4">
                                    <form action="{{ route('admin.stok.tambah', $barang->id) }}" method="POST" class="flex gap-2">
                                        @csrf
